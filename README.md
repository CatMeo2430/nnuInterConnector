...
校园网IPv4支持以下网段：
- `10.0.x.x` (网关: 10.0.0.1)
- `10.7.x.x` (网关: 10.7.0.1)
- `10.20.x.x` (网关: 10.20.0.1)
- `10.24.x.x` (网关: 10.24.0.1)
- `10.28.x.x` (网关: 10.28.0.1)
- `10.29.x.x` (网关: 10.29.0.1)
- `10.30.x.x` (网关: 10.30.0.1)
- `10.100.x.x` (网关: 10.100.0.1)
- `10.128.x.x` (网关: 10.128.0.1)
- `10.132.x.x` (网关: 10.132.0.1)
- `10.136.x.x` (网关: 10.136.0.1)
- `10.137.x.x` (网关: 10.137.0.1)
- `10.247.x.x` (网关: 10.247.0.1)
- `10.252.x.x` (网关: 10.252.0.1)
- `10.253.x.x` (网关: 10.253.0.1)
...
同网段环境下，通过强制路由绕过AP隔离，网关地址为10.x.0.1格式：
